...
#start of the existing code to be tested
class Option:
...
#test cases 
class TestBarkyModules(unittest.TestCase):

    def test_option_choice_is_valid(self):
        self.assertEqual(True, True, "Should be true if the value is true")
    ...
    def test_get_option_choice():
         self.assertEqual("A", "A", "Invalid options")
         self.assertEqual("B", "B", "Invalid options")
         self.assertEqual("T", "T", "Invalid options")
         self.assertEqual("E", "E", "Invalid options")
         self.assertEqual("D", "D", "Invalid options")
         self.assertEqual("G", "G", "Invalid options")
         self.assertEqual("Q", "Q", "Invalid options")
